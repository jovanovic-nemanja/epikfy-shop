        ...
        <div class="container">
            ...
            <div class="home-info-bar clearfix">
                ...
                <div class="col-xs-12 col-md-12">
                    ...
                    <div class="col-md-3 home-info-bar-text">{{ $company['phone_number'] }}</div>
                    <div class="col-md-1 home-info-bar-icon"><div class="glyphicon glyphicon-envelope"></div></div>
                    <div class="col-md-3 home-info-bar-text"><a href="mailto:{{ $company['sales_email'] }}">{{ $company['sales_email'] }}</a></div>
